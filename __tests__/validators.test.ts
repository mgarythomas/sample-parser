...
describe('validateTokens', () => {
  describe('W3C Design Tokens format', () => {
    ...
    it('should validate font tokens correctly', () => {
      ...
      // Individual font properties with 'text' and 'number' types are skipped in current implementation
      // as they don't map to our design token types, so this should throw "No valid tokens found"
